...
const SellGig: React.FC = () => {
  ...
  <div className="flex m-5 flex-col lg:flex-row xl:mx-20">
    <div className="flex flex-col">
      ...
      <div className='flex justify-center gap-x-5 hover:bg-slate-500 hover:bg-opacity-30'>
          <p>Choose photo 1</p>
          <input
            type="file"
            accept="image/*"
          ...
          <tbody>
            {[
              ...
              <tr key={item.id} className="hover">
                ...
                <td>{item.premium}</td>
                <td>{item.deluxe}</td>
                <td><Link href="#" className='underline text-blue-600 hover:text-white hover:scale-105 bg-violet-900 p-1 rounded-xl'>{item.edit}</Link></td>
              </tr>
            ))}
          </tbody>
        </table>
